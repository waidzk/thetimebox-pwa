              ...
              <div id="box-item" className="flex">
                ...
                <div className="box border-y border-[#272343] bg-[#BAE8E8] h-13 flex items-center justify-between px-5 w-1/2">
                  <DatePicker
                    ...
                    onChange={(date) =>
                      updateScheduleTime(date, schedule.idTime)
                    }
      ...
      <div
        className={
          boxLists.current.offsetHeight >= 440
            ...
            : "w-full flex items-center h-10 justify-end pr-5 absolute bottom-20"
        }
      >
        <button
          onClick={() => addScheduleData()}
          className="bg-[#BAE8E8] animate-bounce p-1 rounded-md"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="w-7 h-7 stroke-[#FFD803]"
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
