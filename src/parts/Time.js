...
export default function Time() {
  ...
  return (
    <>
      <h1 className="text-sm text-[#272343] pl-5">Schedule</h1>
      <div>
          ...
          return (
            <div id="box-item" className="flex" key={schedule.idData}>
              <textarea
                ...
                className="outline-none w-1/2 box border-y border-r h-10 border-[#272343] bg-[#BAE8E8] overflow-hidden p-1"
              />
      ...
      <div className="w-full flex items-center h-10 justify-end pr-5">
        <button onClick={addScheduleData}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
            strokeWidth={1.5}
            stroke="currentColor"
            className="w-6 h-6 stroke-[#FFD803]"
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
